...
export class BotConfigController {
  ...
  findAllBots() {
    return this.service.findAllBots();
  }
  ...
  findBot(@Param('botId') botId: string) {
    return this.service.findBot(botId);
  }

  @Post()
  @ApiOperation({ summary: 'Create a new bot instance' })
  @ApiResponse({ status: 201, description: 'Bot instance created' })
  createBot(@Body() dto: CreateBotInstanceDto) {
  ...
  @ApiResponse({ status: 404, description: 'Bot instance not found' })
  updateBot(@Param('botId') botId: string, @Body() dto: UpdateBotInstanceDto) {
  ...
  @ApiResponse({ status: 404, description: 'Bot instance not found' })
  updateScope(@Param('botId') botId: string, @Body() dto: BotScopeDto) {
    return this.service.updateScope(botId, dto);
  }
  ...
  deleteBot(@Param('botId') botId: string) {
    return this.service.deleteBot(botId);
  }
  ...
  findCommands(@Param('botId') botId: string) {
    return this.service.findCommands(botId);
  }
  ...
  createCommand(
    ...
    return this.service.createCommand(botId, dto);
  }
  ...
  updateCommand(
    ...
    return this.service.updateCommand(botId, commandId, dto);
  }
  ...
  deleteCommand(
    ...
    return this.service.deleteCommand(botId, commandId);
  }
  ...
  findResponses(
    ...
    return this.service.findResponses(botId, locale);
  }
  ...
  createResponse(
    @Param('botId') botId: string,
    @Body() dto: CreateBotResponseDto,
  ) {
    return this.service.createResponse(botId, dto);
  }
  ...
  updateResponse(
    ...
    @Body() dto: UpdateBotResponseDto,
  ) {
    return this.service.updateResponse(botId, responseId, dto);
  }
  ...
  deleteResponse(
    ...
    return this.service.deleteResponse(botId, responseId);
  }
  ...
  findMenus(@Param('botId') botId: string) {
    return this.service.findMenus(botId);
  }
  ...
  createMenu(@Param('botId') botId: string, @Body() dto: CreateBotMenuDto) {
    return this.service.createMenu(botId, dto);
  }
  ...
  deleteMenu(@Param('botId') botId: string, @Param('menuId') menuId: string) {
    return this.service.deleteMenu(botId, menuId);
  }
  ...
  addButton(
    ...
    @Body() dto: CreateBotMenuButtonDto,
  ) {
    return this.service.addMenuButton(botId, menuId, dto);
  }
  ...
  updateButton(
    ...
    @Body() dto: UpdateBotMenuButtonDto,
  ) {
    return this.service.updateMenuButton(botId, menuId, buttonId, dto);
  }
  ...
  deleteButton(
    ...
    return this.service.deleteMenuButton(botId, menuId, buttonId);
  }
  ...
  findI18nStrings(
    ...
    return this.service.findI18nStrings(botId, locale);
  }
  ...
  createI18nString(
    @Param('botId') botId: string,
    @Body() dto: CreateI18nStringDto,
  ) {
    return this.service.createI18nString(botId, dto);
  }
  ...
  batchUpdateI18nStrings(
    @Param('botId') botId: string,
    @Body() items: BatchUpdateI18nStringDto[],
  ) {
    return this.service.batchUpdateI18nStrings(botId, items);
  }
  ...
  updateI18nString(
    ...
    @Body() dto: UpdateI18nStringDto,
  ) {
    return this.service.updateI18nString(botId, stringId, dto);
  }
  ...
  deleteI18nString(
    ...
    return this.service.deleteI18nString(botId, stringId);
  }
  ...
  @ApiOperation({
    summary:
      'Bot heartbeat — reports the bot is alive and updates capabilities',
  })
  ...
  @ApiResponse({ status: 404, description: 'Bot instance not found' })
  publishConfig(@Param('botId') botId: string) {
    return this.service.publishConfig(botId);
  }
  ...
  @ApiResponse({ status: 404, description: 'Bot instance not found' })
  getVersion(@Param('botId') botId: string) {
    return this.service.getConfigVersion(botId);
  }
  ...
  @ApiResponse({ status: 404, description: 'Bot instance not found' })
  getVersionHistory(@Param('botId') botId: string) {
    return this.service.getConfigVersionHistory(botId);
  }
}
