 ...
 */
export class BaileysClient implements IWhatsAppTransport {
  ...
  constructor({ connectionId, prisma, logger }: BaileysClientConfig) {
  ...
  async connect(): Promise<void> {
    try {
      ...
      throw new ConnectorError('Failed to connect to WhatsApp', 'TRANSPORT_ERROR', err)
    }
  }
  ...
  async disconnect(): Promise<void> {
    ...
    try {
      ...
      throw new ConnectorError('Failed to disconnect from WhatsApp', 'TRANSPORT_ERROR', err)
    }
  }
  ...
  async sendMessage(
    ...
    try {
      ...
      throw new ConnectorError(`Failed to send message to ${jid}`, 'TRANSPORT_ERROR', err)
    }
  }
  ...
  async sendMedia(
    ...
    try {
      ...
      throw new ConnectorError(`Failed to send ${type} media to ${jid}`, 'TRANSPORT_ERROR', err)
    }
  }
  ...
  async sendDocument(
    ...
    try {
      ...
      throw new ConnectorError(`Failed to send document to ${jid}`, 'TRANSPORT_ERROR', err)
    }
  }
  ...
  async sendLocation(jid: string, lat: number, lng: number): Promise<WhatsAppMessageResult> {
    ...
    try {
      ...
      throw new ConnectorError(`Failed to send location to ${jid}`, 'TRANSPORT_ERROR', err)
    }
  }
  ...
  async sendContact(jid: string, contact: WhatsAppContact): Promise<WhatsAppMessageResult> {
    ...
    try {
      ...
      throw new ConnectorError(`Failed to send contact to ${jid}`, 'TRANSPORT_ERROR', err)
    }
  }
  ...
  async editMessage(
    ...
    try {
      ...
      throw new ConnectorError(`Failed to edit message in ${jid}`, 'TRANSPORT_ERROR', err)
    }
  }
  ...
  async deleteMessage(jid: string, key: WhatsAppMessageKey): Promise<boolean> {
    ...
    try {
      ...
      throw new ConnectorError(`Failed to delete message in ${jid}`, 'TRANSPORT_ERROR', err)
    }
  }
  ...
  async readHistory(jid: string, _count?: number): Promise<void> {
    ...
    try {
      ...
      throw new ConnectorError(`Failed to mark history as read for ${jid}`, 'TRANSPORT_ERROR', err)
    }
  }
  ...
  async kickParticipant(groupJid: string, userJid: string): Promise<boolean> {
    ...
    try {
      ...
      throw new ConnectorError(`Failed to kick ${userJid} from ${groupJid}`, 'TRANSPORT_ERROR', err)
    }
  }
  ...
  async promoteParticipant(groupJid: string, userJid: string): Promise<boolean> {
    ...
    try {
      ...
      throw new ConnectorError(`Failed to promote ${userJid} in ${groupJid}`, 'TRANSPORT_ERROR', err)
    }
  }
  ...
  async demoteParticipant(groupJid: string, userJid: string): Promise<boolean> {
    ...
    try {
      ...
      throw new ConnectorError(`Failed to demote ${userJid} in ${groupJid}`, 'TRANSPORT_ERROR', err)
    }
  }
  ...
  async getGroupMetadata(groupJid: string): Promise<WhatsAppGroupMetadata> {
    ...
    try {
      ...
      throw new ConnectorError(`Failed to get group metadata for ${groupJid}`, 'TRANSPORT_ERROR', err)
    }
  }
  ...
  async getGroupInviteLink(groupJid: string): Promise<string> {
    ...
    try {
      ...
      if (code === undefined || code === null) {
        throw new ConnectorError(`No invite code returned for ${groupJid}`, 'TRANSPORT_ERROR')
      }
      return `https://chat.whatsapp.com/${code}`
    } catch (err) {
      if (err instanceof ConnectorError) throw err
      throw new ConnectorError(`Failed to get invite link for ${groupJid}`, 'TRANSPORT_ERROR', err)
    }
  }
  ...
  async sendPresenceUpdate(jid: string, type: WhatsAppPresenceType): Promise<void> {
    ...
    try {
      ...
      throw new ConnectorError(`Failed to send presence update to ${jid}`, 'TRANSPORT_ERROR', err)
    }
  }
  ...
  private requireSocket(): WASocket {
    if (this.sock === null) {
      throw new ConnectorError('Transport not connected — call connect() first', 'TRANSPORT_ERROR')
    }
    return this.sock
  }
}
...
function buildMediaContent(
  ...
  switch (type) {
    ...
    default: {
      ...
      throw new ConnectorError(`Unknown media type: ${String(_exhaustive)}`, 'TRANSPORT_ERROR')
    }
  }
}
