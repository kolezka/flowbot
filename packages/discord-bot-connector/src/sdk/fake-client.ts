...
export class FakeDiscordClient implements IDiscordBotTransport {
  ...
  async sendComponents(channelId: string, _params: { content?: string, components: unknown[] }): Promise<DiscordMessageResult> {
    return this.makeResult(channelId)
  }
  ...
  getSentMessages(): readonly SentMessage[] { return this.sentMessages }
  getSentEmbeds(): readonly SentEmbed[] { return this.sentEmbeds }
  getSentDMs(): readonly SentDM[] { return this.sentDMs }
  getEditedMessages(): readonly EditedMessage[] { return this.editedMessages }
  getDeletedMessages(): readonly DeletedMessage[] { return this.deletedMessages }
  getPinnedMessages(): readonly PinnedMessage[] { return this.pinnedMessages }
  getUnpinnedMessages(): readonly PinnedMessage[] { return this.unpinnedMessages }
  getAddedReactions(): readonly Reaction[] { return this.addedReactions }
  getRemovedReactions(): readonly Reaction[] { return this.removedReactions }
  getBannedMembers(): readonly BannedMember[] { return this.bannedMembers }
  getKickedMembers(): readonly KickedMember[] { return this.kickedMembers }
  getTimedOutMembers(): readonly TimedOutMember[] { return this.timedOutMembers }
  getAddedRoles(): readonly RoleChange[] { return this.addedRoles }
  getRemovedRoles(): readonly RoleChange[] { return this.removedRoles }
  getNicknameChanges(): readonly NicknameChange[] { return this.nicknameChanges }
  getCreatedChannels(): readonly CreatedChannel[] { return this.createdChannels }
  getDeletedChannels(): readonly string[] { return this.deletedChannels }
  getCreatedThreads(): readonly CreatedThread[] { return this.createdThreads }
  getSentThreadMessages(): readonly SentMessage[] { return this.sentThreadMessages }
  getCreatedRoles(): readonly CreatedRole[] { return this.createdRoles }
  getCreatedInvites(): readonly CreatedInvite[] { return this.createdInvites }
  getMovedMembers(): readonly MovedMember[] { return this.movedMembers }
  getCreatedEvents(): readonly CreatedEvent[] { return this.createdEvents }
